...
const randNum = Math.floor(Math.random()* movies.length-1);
console.log(randNum);
console.log(movies[randNum].explanation)
// const item= movies.explanation[Math.floor(Math.random()* movies.length)];
